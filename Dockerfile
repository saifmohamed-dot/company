...
COPY . .
WORKDIR "/src/company"
RUN dotnet build "./company.csproj" -c $BUILD_CONFIGURATION -o /app/build

# This stage is used to publish the service project to be copied to the final stage
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./company.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
